...
@st.cache_data
def carga_data():
  return pd.read_excel("Chucao_CL_AR.xlsx", header=0)


ciudad = carga_data()
ciudad["Fecha_de_Proceso"] = "25-05-2023"

st.title("Avistamientos históricos de Chucaos en Chile y Argentina.")
st.write("Sí bien se señala que en el siguiente mapa se podrán observar los avistamientos históricos de Chucaos en Chile y Argentina, es más un acercamiento a los datos de avistamientos de los cuales se cuenta registro en la web de Global Biodiversity Information Facility (GBIF, por sus siglas en inglés), información que va desde el año 1989 hasta Abril del año 2023.")
...
st.markdown("#### Avistamiento de Chucaos en Chile y Argentina.")
...
st.write("Como podrán apreciar, para los casos de avistamientos de Chucaos en Chile y Argentina se pueden diferenciar por colores, con el fin de poder crear una mejor experiencia al momento de navegar por el mapa desarrollado. ")
...
def descargar_excel():
    output = pd.ExcelWriter('chucao.xlsx')
    geo_puntos_visual.to_excel(output)
    output.close()
    with open('chucao.xlsx', 'rb') as f:
...
st.write("GBIF.org (28 April 2023) GBIF Occurrence Download  https://doi.org/10.15468/dl.zu6fds")
...
# Estilo CSS para anclar en la parte inferior
    ...
    st.markdown(
            """
            <div class="footer">
                <p>Página web creada por Francisco Javier Aros Muñoz.</p>
